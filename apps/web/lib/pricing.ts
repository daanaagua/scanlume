...
export const EN_WEB_PRICING = {
  monthly: [
    { id: "starter", name: "Starter", price: "$5 / month", credits: "8,000 credits", annualPrice: "$48 / year", annualCredits: "100,000 credits", usage: "8,000 Simple OCR images / 4,000 formatted images / 4,000 PDF pages", limits: "30 files per batch - 20 MB per image - 40 MB per batch" },
    { id: "pro", name: "Pro", price: "$9 / month", credits: "24,000 credits", annualPrice: "$82 / year", annualCredits: "240,000 credits", usage: "24,000 Simple OCR images / 12,000 formatted images / 12,000 PDF pages", limits: "50 files per batch - 20 MB per image - 80 MB per batch", recommended: true },
    { id: "business", name: "Business", price: "$24 / month", credits: "60,000 credits", annualPrice: "$228 / year", annualCredits: "800,000 credits", usage: "60,000 Simple OCR images / 30,000 formatted images / 30,000 PDF pages", limits: "80 files per batch - 30 MB per image - 120 MB per batch" },
  ],
} as const;
...
export const EN_CREDIT_EXPLAINER = [
  "Simple OCR = 1 credit / image",
  "Formatted OCR = 2 credits / image",
  "PDF OCR = 2 credits / processed page",
  "1 formatted OCR image costs only 2 credits on Scanlume.",
...
export const EN_BILLING_DISCLOSURES = [
  "Web credits do not roll over to the next billing period.",
  "Web credits stay tied to the active paid period.",
  "API credits are separate from web credits.",
] as const;
...
export const EN_API_INPUT_NOTE =
